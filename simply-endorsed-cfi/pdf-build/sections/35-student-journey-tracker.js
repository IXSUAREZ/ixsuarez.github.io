...
.jt-sub { font-size: 8pt; color: #475569; margin: 0; }
...
.jt-meta-lbl { font-size: 6.5pt; font-weight: 700; text-transform: uppercase; color: #64748b; }
.jt-meta-line { border-bottom: 0.75pt solid #94a3b8; height: 12pt; }
.jt-table { width: 100%; border-collapse: collapse; font-size: 7.5pt; }
.jt-table th, .jt-table td { border: 0.5pt solid #cbd5e1; padding: 3.5pt 5pt; text-align: left; }
.jt-table th { background: #0f172a; color: #fff; font-weight: 700; font-size: 7pt; text-transform: uppercase; }
.jt-stage-num { font-family: "JetBrains Mono", monospace; font-weight: 800; color: #2563eb; width: 22pt; text-align: center; }
.jt-pills { font-family: "JetBrains Mono", monospace; font-size: 6.5pt; }
</style>`;
