...
(function () {
  ...
  var CERT_TEMPLATES = [
    ...
    { id: "multi-engine", title: "Multi-Engine", subtitle: "Add-on rating", image: "templates/multi-engine.jpg", defaultRating: "MEI", theme: { accent: "#1f2937", soft: "#edeeef", line: "#c7cacd", ink: "#151d27" }, captionEvent: "for passing your multi-engine checkride", captionBody: "Multi-engine training asks a pilot to stay ahead of the airplane: know the systems, recognize the problem, control the aircraft, and make a sound plan. {student} met that challenge and earned a multi-engine rating. Training includes twin-engine systems, Vmc demonstrations, engine-failure scenarios, and the deliberate decisions required for single-engine flight. Kentucky Flight Training Center is proud to celebrate this achievement at Bowman Field in Louisville, Kentucky. For pilots researching multi-engine training in Louisville or a multi-engine add-on rating, this is the kind of focused training that builds confident, capable twin-engine pilots. Congratulations on adding twin-engine capability to an already strong pilot foundation.", hashtags: ["#MultiEngineRating", "#MultiEngineTraining", "#BowmanField", "#LouisvilleAviation"] }, // atp
