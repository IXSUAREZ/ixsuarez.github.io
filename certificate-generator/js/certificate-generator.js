...
(function () {
  ...
  var CAPTION_LOCAL_CONTEXT = "At {school}, our Louisville flight instructors help student pilots and career-minded aviators build practical skills at {airport}. If you are comparing flight schools in Louisville, Kentucky, or researching how to become a pilot, follow along for real training milestones, checkride successes, and the work behind every certificate.";
  ...
  var CERT_TEMPLATES = [
    ...
    { id: "instrument", title: "Instrument", subtitle: "Rating", image: "templates/instrument.jpg", defaultRating: "CFII", theme: { accent: "#64748b", soft: "#f3f4f6", line: "#d8dce2", ink: "#455162" }, captionEvent: "for passing your instrument rating checkride", captionBody: "The instrument rating is built one approach, hold, briefing, and missed approach at a time. {student} earned this rating by learning to manage the airplane and the bigger picture when the view outside is no longer the main reference. That takes discipline, preparation, and trust in the process. Congratulations on becoming an instrument-rated pilot through flight training at Bowman Field. We cannot wait to see where this new capability takes you next.", hashtags: ["#InstrumentRating", "#IFR", "#BowmanField"] }, // instrument-rating
    { id: "commercial", title: "Commercial", subtitle: "Certificate", image: "templates/commercial.jpg", defaultRating: "CFI", theme: { accent: "#ca8a04", soft: "#fbf6eb", line: "#f2e2c0", ink: "#906200" }, captionEvent: "for passing your commercial pilot checkride", captionBody: "A commercial pilot certificate represents a higher standard of precision, judgment, and professionalism. {student} put in the time to sharpen the maneuvers, planning, and confidence required for this checkride—and earned the result. We are proud to recognize another commercial pilot accomplishment at Kentucky Flight Training Center and Bowman Field. This milestone creates new aviation career options while keeping the fundamentals that got you here front and center.", hashtags: ["#CommercialPilot", "#CheckridePassed", "#BowmanField"] }, // commercial-pilot
    { id: "multi-engine", title: "Multi-Engine", subtitle: "Add-on rating", image: "templates/multi-engine.jpg", defaultRating: "MEI", theme: { accent: "#1f2937", soft: "#edeeef", line: "#c7cacd", ink: "#151d27" }, captionEvent: "for passing your multi-engine checkride", captionBody: "Multi-engine training asks a pilot to stay ahead of the airplane: know the systems, recognize the problem, control the aircraft, and make a sound plan. {student} met that challenge and earned a multi-engine rating. We are proud to celebrate this achievement from Bowman Field, where focused flight training turns complex skills into confident habits. Congratulations on adding twin-engine capability to an already strong pilot foundation.", hashtags: ["#MultiEngine", "#TwinEngine", "#BowmanField"] }, // atp
