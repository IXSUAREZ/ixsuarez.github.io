  ...
  },
  {
    ...
    content: [
      ...
      },
      {
        type: "ul",
        value: [
          "AC 61-65 A.14 – Endorsement of U.S. Citizenship recommended by the TSA: 49 CFR 1552.15(c)",
        ],
      },
    ...
    content: [
      ...
      { type: "p", value: "Flight training options — the trainer must have:" },
      {
        ...
        value: [
          ...
          "Given 200 hours of applicable flight training (80 for glider) and completed an FAA-approved Part 141 or Part 142 enhanced qualification program meeting § 61.195(h)(3)",
        ],
      },
    ],
  },
    ...
    content: [
      ...
      { type: "h3", value: "WINGS Program Requirements — AC 61-91" },
      {
        ...
        value: [
          ...
          "Within the preceding 24 calendar months, evaluate and endorse 15 flight activities for at least 5 pilots under the pilot proficiency program",
        ],
      },
      {
        type: "h3",
      ...
      { type: "p", value: "If recent-experience requirements have lapsed:" },
      {
        type: "ul",
        value: [
          "Within 3 calendar months of the last month of the recent-experience period: an approved FIRC or qualifying instructor practical test plus the required application can reinstate privileges. Do not instruct until reinstated.",
          "After 3 calendar months: pass a practical test for an existing or additional instructor rating and submit the application. The separate military route in § 61.199(b) has specific qualification and six-month evidence requirements.",
        ],
      },
  ...
  accordionSections: [
      ...
      blocks: [
        {
          type: "ol",
          value: [
            "Resolve TSA citizenship/eligibility verification before covered flight training",
    ...
    },
    {
      ...
      regs: [
        ...
        "49 CFR 1552.7 \u2014 Verification requirements",
...
window.JOURNEY_STAGES = [
  {
    ...
    description: "Resolve the applicable TSA citizenship or eligibility process before covered flight training. A student pilot certificate and required medical qualification must be in place before solo; they are not prerequisites to every dual lesson.",
    timeLimit: null,
    gotchas: [
  ...
  },
  {
    ...
    description: "Before first solo, administer and review the pre-solo knowledge test under FAR 61.87(b): applicable Parts 61 and 91 rules, airport airspace rules and procedures, and aircraft flight characteristics and limitations. Review incorrect answers, document A.3 and A.4 training, and confirm A.6 make/model solo authorization.",
    timeLimit: null,
    gotchas: [
      "Cover the three subject categories in 61.87(b) and review every incorrect answer before solo",
  ...
  },
  {
    ...
    gotchas: [
      ...
      "A.5 supplements A.3, A.4 and current A.6/A.7 solo authority",
    ],
    notes: [],
  },
  {
    ...
    timeLimit: "Required training within 90 calendar days preceding the solo flight",
    gotchas: [
      ...
      "Check the required training date under § 61.87(n); delaying the first solo does not extend the 90-day training window",
    ],
    notes: [],
  },
  {
  ...
  },
  {
    ...
    description: "For an initial private airplane practical test, review A.37 flight proficiency and A.1 practical-test preparation, plus knowledge-test completion evidence (A.36 is one method) and A.2 deficiency review when applicable. Show all four for review without treating every method as mandatory.",
    timeLimit: "A.1 certifies preparation received and logged within 2 calendar months preceding the month of application",
    gotchas: [
      "Before the knowledge test, verify accepted training completion evidence; A.36 is an instructor endorsement method, not the only permitted evidence",
      "After receiving the knowledge-test report, review identified deficiencies and document A.2 when applicable before the practical test",
      "A.37 (PPL) confirms flight proficiency — this is the certificate-specific endorsement",
      "A.1 certifies recent logged preparation and readiness; check the preparation window against the month of application",
...
window.SCENARIO_CARDS = [
  ...
  },
  {
    ...
    steps: [
      ...
      "Review the original application, preparation recency and continuation requirements with the examiner",
    ...
    pitfalls: [
      ...
      "If a new application or recommendation is needed, recheck the preparation recency required by § 61.39",
      "A discontinuance is not a failure; A.77 is for retesting after failure. Review the continuation and application requirements separately",
    ],
  },
  {
    id: "add-multiengine",
    ...
    timeLimit: "A.1 certifies the required preparation recency under § 61.39(a)(6)",
    pitfalls: [
...
window.QUICK_REF_DATA = {
  ...
  timeLimits: [
    ...
    },
    {
      ...
      appliesTo: "A.1 practical-test preparation — required training must be received and logged within 2 calendar months preceding the month of application",
      governingFAR: "14 CFR § 61.39(a)(6)",
      resetsWhen: "Verify the logged preparation dates and instructor recommendation for the application",
  ...
  acFarTable: [
    ...
    { acRef: "A.5", far: "§ 61.87(o)", use: "Pre-solo flight training at night", expiration: "90 calendar days from night training" },
...
window.CFI_CAREER_DATA = {
  ...
  renewalPathways: [
    ...
    },
    {
      ...
      timeFrame: "Within previous 24 months: 15 activities for 5 pilots; at least 1 phase within previous 12 months",
  ...
  reinstatement: {
    within3Months: {
      heading: "Recent experience lapsed ≤ 3 calendar months",
      path: "Within 3 calendar months of the last month of the recent-experience period, reinstate through an approved FIRC or an instructor practical test, with the required application under § 61.199.",
    ...
    after3Months: {
      heading: "Recent experience lapsed > 3 calendar months",
      path: "Pass a practical test for an existing or additional instructor rating. The separate military route in § 61.199(b) requires qualifying military instructor/examiner status and the specified records within 6 months of application; it is not a general alternative for every CFI.",
  ...
  initialCfiTrainer: {
    ...
    flightOptions: [
      "Meet the certificate/rating requirements in § 61.195(h)(2), then: 24 months as a CFI and 200 hours of flight training for airplane/rotorcraft/powered-lift (80 hours for glider), OR",
      "In the preceding 24 months, endorsed at least 5 applicants and achieved 80% first-attempt success among all applicants endorsed, OR",
      "Given 200 hours of applicable flight training (80 for glider) and completed an FAA-approved enhanced qualification program under Part 141 or Part 142 meeting § 61.195(h)(3)",
    ],
...
window.FLASHCARD_DECK = [
  {
    ...
    question: "What endorsements are required before a student’s first solo?",
    answer: "A.3 — pre-solo knowledge, A.4 — pre-solo flight training, and A.6 — make/model solo authorization. For night solo, A.5 is additional; it does not replace A.6. See § 61.87(b), (c), (n), and (o).",
  },
  {
    id: "fc-02",
    category: "Student Endorsements",
    question: "How long is a first solo endorsement (A.6) valid, and who may issue it?",
    answer: "Under § 61.87(n), the authorized instructor who gave the training endorses the specific make and model. The required training must be within 90 calendar days preceding the solo flight. A.7 addresses additional periods under § 61.87(p).",
  },
  {
    id: "fc-03",
    category: "Student Endorsements",
  ...
  },
  {
    ...
    question: "What time requirement does A.1 certify?",
    answer: "A.1 certifies preparation received and logged within the 2 calendar months preceding the month of application, and readiness for the practical test (§ 61.39(a)(6)). Check the training dates and the model wording; a recent signature alone does not satisfy the training requirement.",
  },
  {
    id: "fc-08",
    category: "Practical Test",
    question: "A student failed a knowledge test. What is the next endorsement step?",
    answer: "Provide the additional training required by § 61.49 and endorse the knowledge-test retest with A.77. After a passing test, review reported deficiencies before the practical test and document A.2 when applicable under § 61.39(a)(6)(iii). A.2 does not replace the retest authorization.",
  },
  {
    id: "fc-09",
    category: "Retesting",
  ...
  },
  {
    ...
    answer: "A CFI conducting an IPC must have the appropriate instrument instructor rating and authority for the aircraft. Section 61.57(d) also permits specified examiners and other approved persons. Review the applicable ACS tasks and document satisfactory completion with A.71.",
  },
  {
    id: "fc-13",
    category: "CFI Career",
  ...
  },
  {
    id: "fc-14",
    category: "CFI Career",
    question: "Your CFI recent experience lapsed 2 months ago. How can you reinstate privileges?",
    answer: "Within 3 calendar months of the last month of the recent-experience period, § 61.199 permits an approved FIRC or a qualifying practical test with the required completed application. Do not exercise instructional privileges until reinstated.",
  },
  {
    id: "fc-15",
    category: "CFI Career",
    question: "Your CFI recent experience lapsed 5 months ago. What is the reinstatement route?",
    answer: "A FIRC alone is insufficient after 3 calendar months. Pass an instructor practical test for an existing or additional rating and submit the required application. Section 61.199(b) provides a separate qualified military instructor/examiner route with specific evidence within 6 months of application.",
  },
];
